                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse" id="navbar-main">
                        ...
                        <%
                            ...
                            ArrayList<String> udll = (ArrayList<String>)session.getAttribute("history");
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="well bs-component">
                            <form class="form-horizontal" action="MyData" method="POST">
                                <fieldset>
                                    <% for(int i=0; i<udll.size(); i++){%>
                                        <div class="form-group">
                                            <label class="col-lg-1 control-label"></label>
                                            <div class="col-lg-10"><br><%= udll.get(i)%></div>
                                    ...
                                    <div class="form-group">
                                            <div class="col-lg-10 col-lg-offset-1">
                                                <button type="submit" class="btn btn-primary">会員情報へ戻る</button>
