                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="well bs-component">
                            <form class="form-horizontal" action="Search?search=<%= hs.getAttribute("s")%>&ac=<%= hs.getAttribute("ac")%>"  method="POST">
                                <fieldset>
                                    <div class="form-group">
                                        <br>
                                        <div align="center">カートに追加しました。</div>
                                    </div>
                                    <div class="form-group">
                                        <div align="center">
                                            <button type="submit" class="btn btn-primary">検索結果一覧へ戻る</button>
                                            <input type="hidden" name="ac"  value="<%= hs.getAttribute("ac")%>">
                                            <input type="hidden" name="search"  value="<%= hs.getAttribute("s")%>">
                                        </div>
                                    </div>
        　　　　　　　　　　　　　</fieldset>
                            </form>
